...
The contents of this repository detail an analysis of the modeling heart disease classification project. This analysis is detailed in hopes of making the work accessible and replicable.
